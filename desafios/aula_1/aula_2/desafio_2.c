...
void bubbleSort(ListaLigada lista) {
    ...
    while(trocou) { //roda enquanto tiver troca na lista. Se o while interno rodar e não tiver troca, ta ordenado. 
        trocou = false;
        Celula j = lista->inicio; // J sempre volta para o início após uma passada.
        while (j->prox != NULL) { //Varre toda a lista até o final. Se houver troca, vira true.
            ...
            j = j->prox; //J anda independente se houve troca ou não. 
        }
    }
}
